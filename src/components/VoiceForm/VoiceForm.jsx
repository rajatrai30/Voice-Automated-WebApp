...
import { Row, Col, Switch, Spin, Alert } from "antd";
import {
  FaMicrophone,
  FaMicrophoneSlash,
  FaTruckLoading,
} from "react-icons/fa";
import { recorder } from "../../voicerecognition";
...
class VoiceForm extends Component {
  ...
  _proccessCommand = (recordedString) => {
    ...
    switch (recordedString) {
      ...
      case "navigate to contact":
        this._RouterContact();
        break;

      // navigate to tutorials page
      case "navigate to tutorials":
        this._RouterTutorials();
        break;
  ...
  _focusNextInput = () => {
    const { activeInput, refs } = this.state;
